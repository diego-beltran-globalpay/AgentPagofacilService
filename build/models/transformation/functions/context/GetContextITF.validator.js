...
exports.isGetContextITF = exports.GetContextITFSchema = exports.ajv = void 0;
/* tslint:disable */
...
exports.isGetContextITF = exports.ajv.compile(exports.GetContextITFSchema);
function validate(value) {
    if (exports.isGetContextITF(value)) {
        return value;
    }
    else {
        throw new Error(exports.ajv.errorsText(exports.isGetContextITF.errors.filter((e) => e.keyword !== "if"), { dataVar: "GetContextITF" }) +
            "\n\n" +
