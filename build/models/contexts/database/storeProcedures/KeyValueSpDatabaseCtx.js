...
exports.KeyValueSpDatabaseCtx = void 0;
const uuid = __importStar(require("uuid"));
const GenericSpDatabaseCtx_1 = require("./GenericSpDatabaseCtx");
class KeyValueSpDatabaseCtx extends GenericSpDatabaseCtx_1.GenericSpDatabaseCtx {
    constructor(options, expTime = 120, expProcessInterval = 15) {
        super(options, expTime, expProcessInterval);
        this.logPrefix = `[KeyValueSpDatabaseCtx][${uuid.v1()}]`;
...
exports.KeyValueSpDatabaseCtx = KeyValueSpDatabaseCtx;
