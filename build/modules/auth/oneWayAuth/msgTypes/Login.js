...
class Login extends controlMsgs_1.MsgCreator {
    ...
    get(startMessage) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const logPrefix = this.transformation.getLogPrefix();
                this.logger.trace(`There was an error trying to get the LOGIN msg. Error: ${err}`, { logPrefix });
            }
            return null;
        });
    }
    analize(message) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.logger.trace(`There was an error trying to get the LOGIN msg. Error: ${err}`);
            }
